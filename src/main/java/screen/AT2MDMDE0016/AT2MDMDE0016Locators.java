 ...
 */
public class AT2MDMDE0016Locators {
    Map<String, String> elements = new HashMap<>();

    public AT2MDMDE0016Locators(String enviroment) {
        setElements();
    }
    ...
    public void setElements() {
        ...
        elements.put("b2b_e_result", "//*[contains(@id, 'pc1:dest::db')]/table/tbody/tr[1]/td[1]");
        elements.put("b2b_e_records", "//*[contains(@id, 'pc1:ot2')]");
        ...
        elements.put("add_i_info_des", "//*[contains(@id, 'pcgt2:it14::content')]");
        ...
        elements.put("add_i_info_age", "//*[contains(@id, 'pcgt2:it5::content')]");
        ...
        elements.put("add_i_info_rec", "//*[contains(@id, 'pcgt2:it4::content')]");
        elements.put("add_i_b2b", "//*[contains(@id, 'pcgt2:seqDestB2b1Id::content')]");
        elements.put("add_lov_b2b", "//*[contains(@id, 'pcgt2:seqDestB2b1Id::lovIconId')]");
        elements.put("add_i_info_b2b", "//*[contains(@id, 'pcgt2:it15::content')]");
        elements.put("add_i_zone", "//*[contains(@id, 'pcgt2:it1::content')]");
        elements.put("add_i_intf", "//*[contains(@id, 'pcgt2:it3::content')]");
        elements.put("add_ck_active", "//*[contains(@id, 'pcgt2:sbc2::content')]");
        //QBE
        elements.put("qbe_sl_type", "//*[contains(@id, 'soc3::content')]");
        elements.put("qbe_i_destination", "//*[contains(@id, 'afr_c3::content')]");
        elements.put("qbe_i_info_des", "//*[contains(@id, 'afr_c11::content')]");
        elements.put("qbe_i_agency", "//*[contains(@id, 'it8::content')]");
        elements.put("qbe_i_info_age", "//*[contains(@id, 'afr_c10::content')]");
        elements.put("qbe_i_receptive", "//*[contains(@id, 'it7::content')]");
        elements.put("qbe_i_info_rec", "//*[contains(@id, 'afr_c9::content')]");
        elements.put("qbe_i_b2b", "//*[contains(@id, 'it6::content')]");
        elements.put("qbe_i_info_b2b", "//*[contains(@id, 'afr_c12::content')]");
