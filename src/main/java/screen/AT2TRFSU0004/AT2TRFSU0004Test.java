...
public class AT2TRFSU0004Test {
    ...
    private boolean create(TestDriver driver, boolean add) {
        ...
        //falla en modo debugging, pero si lanzamos la pantalla normal o en manual va bien.
        ...
        // OJO en test, la descripción de al lado parece que se guarda pero al buscarla desaparece y
        //Se meten datos hardcodeados (están en data) porque no es bug, son idiomas que no están activados en
        //mdmor0028
        if (!Functions.createLovByValue(driver,
                new String[]{"add_lov_language", getElements("add_lov_language")}, //LoV button
                new String[]{"add_i_language", getElements("add_i_language")}, //external LoV input
                new String[]{"add_lov_language_i_codIdioma", recursiveXPaths.lov_i_genericinput}, //internal LoV input
                getData(update + "add_language"), // value to search
