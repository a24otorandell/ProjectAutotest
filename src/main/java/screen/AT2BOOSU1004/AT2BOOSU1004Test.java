...
public class AT2BOOSU1004Test {
    ...
    private boolean Edit_configuration_by_clients(TestDriver driver) {
        ...
        if (!Functions.insertInput(driver, new String[]{"configuration_by_clients_rating_ed_i_arrival_date_from", getElements("configuration_by_clients_rating_ed_i_arrival_date_from")},
                "arrival_from", DataGenerator.getRelativeDateToday("MM/dd/yyyy", 0, DataGenerator.random(2, 2), 0), where)) {
            return false;
        }
        ...
        if (!Functions.insertInput(driver, new String[]{"configuration_by_clients_rating_ed_i_stay_date_from", getElements("configuration_by_clients_rating_ed_i_stay_date_from")},
                "Stay_from", DataGenerator.getRelativeDateToday("MM/dd/yyyy", 0, DataGenerator.random(2, 2), 0), where)) {
            return false;
        }
        ...
        if (!Functions.selectText(driver,
                ...
                "Reconfirm BMS", "include_bms", where)) {
            return false;
        }

        if (!Functions.checkboxValue(driver,
                getElements("configuration_by_clients_rating_ed_ch_include_dns_hotels"), "include_dns_hotels", false, true, where)) {
            return false;
        }//where

        if (!Functions.checkboxValue(driver,
                getElements("configuration_by_clients_rating_ed_ch_include_ref_to_client"), "include_ref_to_client", false, true, where)) {
            return false;
        }//where
        ...
        if (!Functions.insertInput(driver, new String[]{"configuration_by_clients_rating_ed_i_project_name", getElements("configuration_by_clients_rating_ed_i_project_name")},
                "project_name", "PRUEBA2", where)) {
            return false;
        }

        if (!Functions.checkboxValue(driver,
                getElements("configuration_by_clients_rating_ed_ch_active"), "active", false, true, where)) {
            return false;
        }//where
        ...
        if (!Functions.insertInput(driver, new String[]{"configuration_by_clients_rating_ed_i_arrival_date_to", getElements("configuration_by_clients_rating_ed_i_arrival_date_to")},
                "arrival_to", DataGenerator.getRelativeDateToday("MM/dd/yyyy", 0, DataGenerator.random(2, 2), 0), where)) {
            return false;
        }
        ...
        if (!Functions.insertInput(driver, new String[]{"configuration_by_clients_rating_ed_i_stay_date_to", getElements("configuration_by_clients_rating_ed_i_stay_date_to")},
                "stay_to", DataGenerator.getRelativeDateToday("MM/dd/yyyy", 0, DataGenerator.random(2, 2), 0), where)) {
            return false;
        }
        ...
        if (!Functions.selectText(driver,
                ...
                "Reconfirm B2B", "integrations", where)) {
            return false;
        }

        if (!Functions.checkboxValue(driver,
                getElements("configuration_by_clients_rating_ed_ch_client_confirmation"), "client_confirmation", false, true, where)) {
            return false;
        }//where

        if (!Functions.checkboxValue(driver,
                getElements("configuration_by_clients_rating_ed_ch_send_copy_kam"), "copy_kam", false, true, where)) {
            return false;
        }//where
    ...
    private boolean Search_configuration_by_clients(TestDriver driver) {
        ...
        if (!Functions.selectText(driver,
                new String[]{"configuration_by_clients_rating_sl_include_ref_to_client", getElements("configuration_by_clients_rating_sl_include_ref_to_client")},
                "Yes", "se_to_clients", where)) {
            return false;
        }

        if (!Functions.selectText(driver,
                new String[]{"configuration_by_clients_rating_sl_client_confirmation", getElements("configuration_by_clients_rating_sl_client_confirmation")},
                "Yes", "se_client_confirmation", where)) {
            return false;
        }
        if (!Functions.selectText(driver,
                new String[]{"configuration_by_clients_rating_sl_send_copy_kam", getElements("configuration_by_clients_rating_sl_send_copy_kam")},
                "Yes", "se_copy_kam", where)) {
            return false;
        }
    ...
    private boolean Add_configuration_by_clients(TestDriver driver) {
        ...
        if (!Functions.insertInput(driver, new String[]{"configuration_by_clients_rating_add_i_arrival_date_from", getElements("configuration_by_clients_rating_add_i_arrival_date_from")},
                "arrival_from", DataGenerator.getRelativeDateToday("MM/dd/yyyy", 0, DataGenerator.random(1, 1), 0), where)) {
            return false;
        }
        ...
        if (!Functions.insertInput(driver, new String[]{"configuration_by_clients_rating_add_i_stay_date_from", getElements("configuration_by_clients_rating_add_i_stay_date_from")},
                "Stay_from", DataGenerator.getRelativeDateToday("MM/dd/yyyy", 0, DataGenerator.random(1, 1), 0), where)) {
            return false;
        }
        ...
        if (!Functions.selectText(driver,
                ...
                "Exclude BMS", "include_bms", where)) {
            return false;
        }

        if (!Functions.checkboxValue(driver,
                getElements("configuration_by_clients_rating_add_ch_include_dns_hotels"), "include_dns_hotels", true, true, where)) {
            return false;
        }//where

        if (!Functions.checkboxValue(driver,
                getElements("configuration_by_clients_rating_add_ch_include_ref_to_client"), "include_ref_to_client", true, true, where)) {
            return false;
        }//where
        ...
        if (!Functions.checkboxValue(driver,
                getElements("configuration_by_clients_rating_add_ch_active"), "active", true, true, where)) {
            return false;
        }//where
        ...
        if (!Functions.checkboxValue(driver,
                getElements("configuration_by_clients_rating_add_ch_client_confirmation"), "client_confirmation", true, true, where)) {
            return false;
        }//where

        if (!Functions.checkboxValue(driver,
                getElements("configuration_by_clients_rating_add_ch_send_copy_kam"), "copy_kam", true, true, where)) {
            return false;
        }//where
