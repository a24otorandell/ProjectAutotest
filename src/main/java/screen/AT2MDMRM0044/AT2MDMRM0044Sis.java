...
public class AT2MDMRM0044Sis {
    ...
    private boolean qbe(TestDriver driver) {
        ...
        //COMPROBAR SI FILTRAN CORRECTAMENTE
      if (!Functions.selectText(driver,
    ...
    private boolean delete_4(TestDriver driver) {
        ...
        if (!Functions.doDeleteNCheck(driver,
                ...
                new String[]{"concepts_b_delete_yes", getElements("concepts_b_delete_yes")}, //delete button yes
                where)){
            return false;
        }
        return true;
