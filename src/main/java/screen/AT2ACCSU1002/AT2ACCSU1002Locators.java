...
public class AT2ACCSU1002Locators {
    ...
    public void setElements (){
        ...
        //OTHER ACTIONS
        elements.put("hotel_category_lenguage_data_oa","//*[contains(@id, 'pc2:pcgm1:dc_m1')]/div/table/tbody/tr/td[2]/a");
        elements.put("hotel_category_lenguage_data_oa","//*[contains(@id, 'pc2:pcgm1:dc_cmi1')]/td[2]");
        elements.put("hotel_category_lenguage_data_oa","//*[contains(@id, 'pc2:d2::ok')]");
        elements.put("hotel_category_lenguage_data_oa","//*[contains(@id, 'pc2:_dchTbr')]/a");


        //DELETE
        elements.put("hotel_category_lenguage_data_del","//*[contains(@id, 'pc2:pcgt38:boton_remove')]");
        elements.put("hotel_category_lenguage_data_del","//*[contains(@id, 'pc2:ot77')]");
        elements.put("hotel_category_lenguage_data_del","//*[contains(@id, 'pc2:pcgt38:cbt1')]");
