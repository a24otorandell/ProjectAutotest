...
public class AT2ACCSU0075Locators {
    ...
    public void setElements() {
        ...
        //SEARCH
            ...
            elements.put("search_i_grupo", "//*[contains(@id, 'qryId1:value20::content')]");
            elements.put("search_lov_grupo", "//*[contains(@id, 'qryId1:value20::lovIconId')]");
            elements.put("search_i_concepto", "//*[contains(@id, 'qryId1:value30::content')]");
            elements.put("search_lov_concepto", "//*[contains(@id, 'qryId1:value30::lovIconId')]");
        //QBE
