...
public class AT2ACCSU0025Manager implements AT2Test {
    ...
    public AT2ACCSU0025Manager(String enviroment) {
        if (enviroment.equalsIgnoreCase("test")) {
            entorno = "test";
            setTest(new AT2ACCSU0025Test());
            this.test.setData(new AT2ACCSU0025Data(enviroment));
            this.test.setLocators(new AT2ACCSU0025Locators(enviroment));
        } else {
            entorno = "sis";
            setTestSis(new AT2ACCSU0025Sis());
            this.sis.setData(new AT2ACCSU0025Data(enviroment));
