 ...
 */
public class AT2MDMDE0015Test {
    protected AT2MDMDE0015Locators locators;
    protected AT2MDMDE0015Data data;
    public AT2MDMDE0015Test() {
    }
    public AT2MDMDE0015Locators getLocators() {
        return locators;
    }
    public void setLocators(AT2MDMDE0015Locators locators) {
        this.locators = locators;
    }
    public AT2MDMDE0015Data getData() {
        return data;
    }
    public void setData(AT2MDMDE0015Data data) {
        this.data = data;
    }
