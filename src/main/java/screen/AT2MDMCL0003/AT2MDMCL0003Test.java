...
/*        if (!optionSelect1(driver)) return false;
    ...
    private boolean search_t1_3(TestDriver driver, boolean first) {
        ...
        if (first) {
            if (!Functions.checkClick(driver,
                    new String[]{"search_b_show_search", getElements("search_b_show_search")}, //element to click
                    new String[]{"search_i_commercial_country3", getElements("search_i_commercial_country3")}, //element expected to appear
                    where)) {
                return false;
            }
        }
    ...
    private boolean search_t1_5(TestDriver driver, boolean first) {
        ...
        if (first) {
            if (!Functions.checkClick(driver,
                    new String[]{"search_b_show_search", getElements("search_b_show_search")}, //element to click
                    new String[]{"search_i_invoicing", getElements("search_i_invoicing")}, //element expected to appear
                    where)) {
                return false;
            }
        }
    ...
    private boolean search_t1_7(TestDriver driver, boolean first) {
        ...
        if (first) {
            if (!Functions.checkClick(driver,
                    new String[]{"search_b_show_search", getElements("search_b_show_search")}, //element to click
                    new String[]{"search_i_atlas_c", getElements("search_i_atlas_c")}, //element expected to appear
                    where)) {
                return false;
            }
        }
    ...
    private boolean search_t1_16(TestDriver driver, boolean first) {
        ...
        if (first) {
            if (!Functions.checkClick(driver,
                    new String[]{"search_b_show_search", getElements("search_b_show_search")}, //element to click
                    new String[]{"search_i_duplicity", getElements("search_i_duplicity")}, //element expected to appear
                    where)) {
                return false;
            }
        }
