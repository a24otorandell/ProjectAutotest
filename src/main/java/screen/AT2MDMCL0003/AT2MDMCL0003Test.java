...
import sun.text.resources.cldr.ar.FormatData_ar_YE;
...
/*        if (!getData(driver)) return false;*/
    ...
    public boolean interaction_add_t1_2 (TestDriver driver) {
        ...
        if (!Functions.insertInput(driver, new String[]{"add_i_hotelmodel", getElements("add_i_hotelmodel")},
                "hotel_m", DataGenerator.getRandomAlphanumericSequence(8, false), where)) {
            return false;
        }
    ...
    private boolean search_t1_2(TestDriver driver) {
        ...
        if (!Functions.insertInput(driver, new String[]{"search_i_hotelmodel", getElements("search_i_hotelmodel")},
                "hotel_m", getData("hotel_m"), where)) {
            return false;
        }
        if (!Functions.clickSearchAndResult(driver,
                new String[]{"search_b_search", getElements("search_b_search")}, //search button
    ...
    public boolean interaction_add_t1_3 (TestDriver driver) {
        ...
        if (!Functions.insertInput(driver, new String[]{"add_i_hotelextras3", getElements("add_i_hotelextras3")},
                "hotel_e3", DataGenerator.getRandomAlphanumericSequence(8, false), where)) {
            return false;
        }
    ...
    private boolean search_t1_3(TestDriver driver) {
        ...
        if (!Functions.insertInput(driver, new String[]{"search_i_hotelextras3", getElements("search_i_hotelextras3")},
                "hotel_e3", getData("hotel_e3"), where)) {
            return false;
        }
        if (!Functions.clickSearchAndResult(driver,
                new String[]{"search_b_search", getElements("search_b_search")}, //search button
    ...
    public boolean interaction_add_t1_4 (TestDriver driver) {
        ...
        if (!Functions.insertInput(driver, new String[]{"add_i_hotelextras4", getElements("add_i_hotelextras4")},
                "hotel_e4", DataGenerator.getRandomAlphanumericSequence(8, false), where)) {
            return false;
        }
    ...
    private boolean search_t1_4(TestDriver driver) {
        ...
        if (!Functions.insertInput(driver, new String[]{"search_i_hotelextras4", getElements("search_i_hotelextras4")},
                "hotel_e4", getData("hotel_e4"), where)) {
            return false;
        }
        if (!Functions.clickSearchAndResult(driver,
                new String[]{"search_b_search", getElements("search_b_search")}, //search button
    ...
    public boolean interaction_add_t1_6 (TestDriver driver) {
        ...
        if (!Functions.checkClick(driver,
                new String[]{"inputs_b_add", getElements("inputs_b_add")}, //element to click
                recursiveXPaths.glass,
                100,300,//element expected to appear
                where)) {
            return false;
        }
    ...
    public boolean interaction_add_t1_9 (TestDriver driver) {
        ...
        if (!Functions.checkClick(driver,
                new String[]{"inputs_b_add", getElements("inputs_b_add")}, //element to click
                recursiveXPaths.glass,
                120, 500,//element expected to appear
                where)) {
            return false;
        }
    ...
    public boolean interaction_add_t1_12 (TestDriver driver) {
        ...
        if (!Functions.insertInput(driver, new String[]{"add_i_princing12", getElements("add_i_princing12")},
                "princing12",DataGenerator.getRandomAlphanumericSequence(5, false), where)) {
            return false;
        }
        ...
        if (!Functions.insertInput(driver, new String[]{"add_i_billing", getElements("add_i_billing")},
                "billing",DataGenerator.getRandomAlphanumericSequence(2, false), where)) {
            return false;
        }
        if (!Functions.checkClickByAbsence(driver,
                new String[]{"add_b_save1", getElements("add_b_save1")}, //e1
    ...
    private boolean search_t1_12(TestDriver driver) {
        ...
        if (!Functions.insertInput(driver, new String[]{"search_i_princing12", getElements("search_i_princing12")},
                "princing12", getData("princing12"), where)) {
            return false;
        }
    ...
    private boolean interaction_edit_t2_12(TestDriver driver) {
        ...
        if (!Functions.insertInput(driver, new String[]{"edit_i_billing", getElements("edit_i_billing")},
                "billing",DataGenerator.getRandomAlphanumericSequence(2, false), where)) {
            return false;
        }
        Functions.break_time(driver,3, 500);
