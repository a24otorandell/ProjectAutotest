...
/*        elements.put("transaction_b_add", "/*//*[contains(@id, 'pcgt2:boton_add')]");
        ...
        elements.put("transaction_e_result_1", "//*[contains(@id, 'pc1:t1::db')]/table/tbody/tr[1]/td[1]");
        elements.put("transaction_e_result", "//*[contains(@id, 'pc1:t1::db')]/table/tbody/tr[22]/td[1]");
        elements.put("transaction_e_result_sis", "//*[contains(@id, 'pc1:t1::db')]/table/tbody/tr[14]/td[1]");
        ...
        elements.put("qbe_sl_operator", "//*[contains(@id, 'pc1:t1:soc1::content')]");
...
/*        elements.put("transaction_b_add", "/*//*[contains(@id, 'pcgt2:boton_add')]");
        ...
        elements.put("load_e_result_1", "//*[contains(@id, 'pc1:t1::db')]/table/tbody/tr[4]/td[1]");
