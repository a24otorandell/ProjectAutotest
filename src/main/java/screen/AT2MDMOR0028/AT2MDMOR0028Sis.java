...
public class AT2MDMOR0028Sis {
    ...
    private boolean webLabelTestCSED(TestDriver driver) {
        ...
        if (!webLabelLanguagesTabWebLabelLanguagesTableRecordInteraction(driver, true)) {
            return false;
        }
        ...
        if (!webLabelLanguagesTabWebLabelLanguagesTableDelete(driver)) {
            return false;
        }
        return true;
    }
    ...
    private boolean webLabelLanguagesTabwebLabelLanguagesDescriptionTableTestCSED(TestDriver driver) {
        ...
        if (!webLabelLanguagesTabWebLabelLanguagesDescriptionTableRecordInteraction(driver, true)) {
            return false;
        }
        if (!webLabelLanguagesTabWebLabelLanguagesDescriptionTableQuery(driver)) {
            return false;
        }
        if (!webLabelLanguagesTabWebLabelLanguagesDescriptionTableRecordInteraction(driver, false)) {
            return false;
        }
        if (!webLabelLanguagesTabWebLabelLanguagesDescriptionTableQuery(driver)) {
            return false;
        }
        if (!webLabelLanguagesTabWebLabelLanguagesDescriptionTableExtraActions(driver)) {
            return false;
        }
        if (!webLabelLanguagesTabWebLabelLanguagesDescriptionTableQuery(driver)) {
            return false;
        }
        if (!webLabelLanguagesTabWebLabelLanguagesDescriptionTableDelete(driver)) {
            return false;
        }
    ...
    private boolean webLabelLanguagesTabWebLabelLanguagesTableQuery(TestDriver driver) {
        ...
        if (!Functions.selectText(driver,
                ...
                getData("web_label_languages_active"),
                "web_label_languages_active",
                " on \"WEB LABEL LANGUAGES\" TAB, \"WEB LABEL LANGUAGES\" TABLE QUERY ")) {
            return false;
        }
        if (!Functions.enterQueryAndClickResult(driver,
    ...
    private boolean webLabelLanguagesTabWebLabelLanguagesTableSearch(TestDriver driver) {
        ...
        if (!Functions.checkboxValue(driver,
                getElements("web_label_languages_tab_web_label_languages_table_search_cb_active"),
                "web_label_languages_active",
                true,
                " on \"WEB LABEL LANGUAGES\" TAB, \"WEB LABEL LANGUAGES\" TABLE SEARCH ")) {
            return false;
    ...
    private boolean webLabelLanguagesTabWebLabelLanguagesTableRecordInteraction(TestDriver driver, boolean add) {
        ...
        if (add) {
            ...
            if (!Functions.checkboxValue(driver,
                    getElements("web_label_languages_tab_web_label_languages_table_record_interaction_cb_active"),
                    "web_label_languages_active",
                    true,
                    true,
                    " on \"WEB LABEL LANGUAGES\" TAB, \"WEB LABEL LANGUAGES\" TABLE ADD ")) {
    ...
    private boolean languageTestCSED(TestDriver driver) {
        ...
        if (!Functions.checkClick(driver,
                ...
                " to GO TO \"LANGUAGE\" TAB")) {
            return false;
        }

        if (!languageTabLanguageCodeTableRecordInteraction(driver, true)) {
            return false;
        }
        ...
        if (!languageTabLanguageDescriptionTestCSED(driver)) {
            return false;
        }/*
        if (!languageTabLanguageCodeTableSearch(driver)) {
            return false;
        }*/
        if (!languageTabLanguageCodeTableDelete(driver)) {
            return false;
        }
        return true;
    ...
    private boolean languageTabLanguageCodeTableDelete(TestDriver driver) {
        ...
        if (!Functions.doDelete(driver,
                ...
                " on \"LANGUAGE\" TAB, \"LANGUAGE CODE\" TABLE DELETE")) {
            return false;
        }
    ...
    private boolean languageTabLanguageDescriptionTestCSED(TestDriver driver) {
        ...
        if (!languageTabLanguageDescriptionTableRecordInteraction(driver, true)) {
            return false;
        }
        if (!languageTabLanguageDescriptionTableQuery(driver)) {
            return false;
        }
        if (!languageTabLanguageDescriptionTableRecordInteraction(driver, false)) {
            return false;
        }
        if (!languageTabLanguageDescriptionTableQuery(driver)) {
            return false;
        }
        if (!languageTabLanguageDescriptionTableExtraActions(driver)) {
            return false;
        }
        if (!languageTabLanguageDescriptionTableDelete(driver)) {
            return false;
        }
        return true;
    }
    ...
    private boolean languageTabLanguageDescriptionTableDelete(TestDriver driver) {
        ...
        while (recordsToDelete) {
            ...
            if (!Functions.doDelete(driver,
                    ...
                    " on \"LANGUAGE\" TAB, \"LANGUAGE DESCRIPTION\" TABLE DELETE ")) {
                return false;
            }
            try {
    ...
    private boolean languageTabLanguageDescriptionTableExtraActions(TestDriver driver) {
        ...
        if (!Functions.auditData(driver,
                ...
                new String[]{"language_tab_language_description_table_audit_b_ok",
                        recursiveXPaths.audit_b_ok}, //audit_b_ok
                " to AUDIT \"LANGUAGE\" TAB, \"LANGUAGE DESCRIPTION\" TABLE DATA ")) {
            return false;
        }
        if (!Functions.detachTable(driver,
                ...
                true,
                " to DETACH \"LANGUAGE\" TAB, \"LANGUAGE DESCRIPTION\" TABLE ")) {
            return false;
        }
        return true;
    }
    ...
    private boolean languageTabLanguageCodeTableQuery(TestDriver driver) {
        ...
        if (!Functions.selectText(driver,
                ...
                getData("language_tab_language_code_status"),
                "language_tab_language_code_status",
                " on \"LANGUAGE\" TAB, \"LANGUAGE CODE\" TABLE QUERY ")) {
            return false;
        }
        if (!Functions.insertInput(driver,
    ...
    private boolean languageTabLanguageDescriptionTableRecordInteraction(TestDriver driver, boolean add) {
        if (add) {
            ...
            if (!Functions.createLovByValue(driver,
                    ...
                    " on \"LANGUAGE\" TAB, \"LANGUAGE DESCRIPTION\" TABLE ADD")) {
                return false;
            }
            if (!Functions.insertInput(driver,
            ...
            if (!Functions.checkClick(driver,
                    ...
                    recursiveXPaths.glass,
                    " on \"LANGUAGE\" TAB, \"LANGUAGE DESCRIPTION\" TABLE EDIT")) {
                return false;
            }
            if (!Functions.createLovByValue(driver,
                    new String[]{"language_tab_language_description_table_record_interaction_code_b_lov",
    ...
    private boolean languageTabLanguageCodeTableExtraActions(TestDriver driver) {
        ...
        if (!Functions.auditData(driver,
                ...
                " to AUDIT \"LANGUAGE\" TAB, \"LANGUAGE CODE\" TABLE DATA")) {
            return false;
        }
        if (!Functions.detachTable(driver,
                ...
                true,     //screenshot??
                " to DETACH \"LANGUAGE\" TAB, \"LANGUAGE CODE\" TABLE")) {
            return false;
        }
    ...
    private boolean languageTabLanguageCodeTableSearch(TestDriver driver) {
        ...
        if (!Functions.insertInput(driver,
                ...
                "language_tab_language_code_table_language_code",
                getData("language_tab_language_code_table_language_code"),
                " on \"LANGUAGE\" TAB, \"LANGUAGE CODE\" TABLE SEARCH ")) {
            return false;
        }
        if (!Functions.insertInput(driver,
        ...
        if (!Functions.checkboxValue(driver,
                getElements("language_tab_language_code_table_search_cb_status"),
                "language_tab_language_code_status",
                true,
                " on \"LANGUAGE\" TAB, \"LANGUAGE CODE\" TABLE SEARCH")) {
            return false;
        ...
        Functions.break_time(driver, 2, 1000);
        if (!Functions.insertInput(driver,
    ...
    private boolean languageTabLanguageCodeTableRecordInteraction(TestDriver driver, boolean add) {
        ...
        if (add) {
            ...
            if (!Functions.insertInput(driver,
                    ...
                    "language_tab_language_code_table_language_code",
                    getData("language_tab_language_code_table_language_code"),
                    " on \"LANGUAGE\" TAB, \"LANGUAGE CODE\" TABLE ADD")) {
                return false;
            }
            if (!Functions.insertInput(driver,
            ...
            if (!Functions.checkboxValue(driver,
                    getElements("language_tab_language_code_table_record_interaction_cb_status"),
                    "language_tab_language_code_status",
                    true,
                    true,
                    " on \"LANGUAGE\" TAB, \"LANGUAGE CODE\" TABLE ADD")) {
            ...
            if (!Functions.insertInput(driver,
                    ...
                    " on \"LANGUAGE\" TAB, \"LANGUAGE CODE\" TABLE EDIT")) {
                return false;
            }
            if (!Functions.insertInput(driver,
                    new String[]{"language_tab_language_code_table_record_interaction_i_language_description",
