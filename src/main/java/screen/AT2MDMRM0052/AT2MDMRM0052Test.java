...
/**
 * HARDCODEO EL VALOR DE CAMPAING PARA ENCONTRAR REGISTROS.
 */
public class AT2MDMRM0052Test {
    protected AT2MDMRM0052Locators locators;
    protected AT2MDMRM0052Data data;
    public AT2MDMRM0052Test() {
    }
    ...
    public boolean botonDest (TestDriver driver)  {
        ...
        if (!Functions.simpleClick(driver,
                ...
                where)){return false;}
        Functions.break_time(driver, 3, 500);
        driver.getDriver().get("http://atlbiptest.hotelbeds.com/xmlpserver/reports/ATLAS20/MDM/XDO/AT2MDMRP0016.xdo?_xpf=&_xpt=0&_xmode=&_xt=AT2MDMRP0016_01&_xf=analyze&_xana=view");
    ...
    public boolean botonTo (TestDriver driver)  {
        ...
        if (!Functions.simpleClick(driver,
                ...
                where)){return false;}
        Functions.break_time(driver, 3, 500);
        driver.getDriver().get("http://atlbiptest.hotelbeds.com/xmlpserver/reports/ATLAS20/MDM/XDO/AT2MDMRP0017.xdo?_xpf=&_xpt=0&_xmode=&_xt=AT2MDMRP0017_01&_xf=analyze&_xana=view");
        Functions.screenshot(driver);
        driver.getDriver().navigate().to(windowsadf);
        return true;
    }
