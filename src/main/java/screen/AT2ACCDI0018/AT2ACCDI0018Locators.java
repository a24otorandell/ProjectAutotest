...
public class AT2ACCDI0018Locators {
    ...
    public void setElements() {
        ...
        elements.put("search_i_booking_type", "//*[contains(@id, 'qryId1:value30::content')]");
        elements.put("search_lov_booking_type", "//*[contains(@id, 'qryId1:value30::lovIconId')]");
        ...
        elements.put("search_i_from_date", "//*[contains(@id, 'qryId1:value50::content')]");
        elements.put("search_i_to_date", "//*[contains(@id, 'qryId1:value60::content')]");
        elements.put("search_i_days", "//*[contains(@id, 'qryId1:value70::content')]");
        elements.put("search_i_time", "//*[contains(@id, 'qryId1:value80::content')]");
        elements.put("search_i_cost", "//*[contains(@id, 'qryId1:value90::content')]");
        elements.put("search_i_amount_cost", "//*[contains(@id, 'qryId1:value100::content')]");
        elements.put("search_i_extra", "//*[contains(@id, 'qryId1:value110::content')]");
        elements.put("search_i_amount_extra", "//*[contains(@id, 'qryId1:value120::content')]");
        elements.put("search_i_currency", "//*[contains(@id, 'qryId1:value130::content')]");
        elements.put("search_lov_currency", "//*[contains(@id, 'qryId1:value130::lovIconId')]");
        elements.put("search_sl_application_type", "//*[contains(@id, 'qryId1:value140::content')]");
        elements.put("search_sl_application_cost", "//*[contains(@id, 'qryId1:value150::content')]");
        elements.put("search_ck_net_amount", "//*[contains(@id, 'qryId1:value160::content')]");
